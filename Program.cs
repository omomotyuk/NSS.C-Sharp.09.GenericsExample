    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (selection == "1")
            {
                ...
                dvdPage.ForEach(m => Console.WriteLine($"{m.Title} ({m.Genre})"));

                while( true )
                {
                    Console.WriteLine("\nType Next or Prev to go forward or back:");
            ...
            if (selection == "2")
            {
                ...
                bookPage.ForEach(b => Console.WriteLine($"{b.Title} by {b.Author}"));
                ...
                while( true )
                {
                    ...
                    {
                        var prevPage = bookPager.GetPreviousPage();
                        prevPage.ForEach( b => Console.WriteLine($"{b.Id} {b.Title} by {b.Author}"));
                    }
                    else
                    {
                        break;
